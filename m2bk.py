...
class DatasetHandler:
    ...
    def __init__(self):
        ...
        self.image_dir = os.path.join(root_dir_path, 'odometry_data/images')
        self.depth_dir = os.path.join(root_dir_path, 'odometry_data/depths')
        ...
        self.k = np.array([[316.5971768 ,   0.        , 154.25497779],
