...
imageSize = tuple(calibration_data['image_dims'])
leftMapX = calibration_data['left_map_1']
leftMapY = calibration_data['left_map_2']
rightMapX = calibration_data['right_map_1']
rightMapY = calibration_data['right_map_2']
